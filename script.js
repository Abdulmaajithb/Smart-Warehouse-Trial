 const products = [
      ...
      { id: 4, name: 'Eraser', price: 2.00, image: 'images/eraser.jpg', description: 'Perfect for erasing mistakes' },
      ...
      { id: 9, name: 'Stapler', price: 60.00, image: 'images/stapler.jpg', description: 'Heavy-duty stapler for binding papers' },
      ...
      { id: 17, name: 'Folder', price: 15.00, image: 'images/folder.jpg', description: 'Plastic folder for document' },
  ...
  fetch('http://192.168.137.205:5000/api/order', { // Corrected URL
    method: 'POST',
    headers: {
  ...
  .catch(error => {
    ...
    function toggleTheme() {
      ...
      button.textContent = isDark ? '☀️ Dark Mode' : '🌙 Light Mode';
    }
